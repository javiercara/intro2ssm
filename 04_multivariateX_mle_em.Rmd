---
title: "Multivariate case with exogenous inputs: maximum likelihood estimation (Expectation-Maximization)"
author: "Javier Cara"
date: "2020-02"
output: 
  html_document:
...
m1i = rep(0,nx)
P1i = diag(nx)
Bi = matrix(rep(0,nx*nu),nrow = nx)
Di = matrix(rep(0,ny*nu), nrow = ny)
```

## EM algorithm

```{r}
ssm_e = emssm::ABCDQR_em(y,u,Ai,Bi,Ci,Di,Qi,Ri,m1i,P1i,max_iter = 50,ny = ny,nx = nx,nu = nu,txo = T, Be = F)
```
